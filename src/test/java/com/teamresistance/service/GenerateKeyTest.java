...
class GenerateKeyTest {
    ...
    @Test
    void getFavorites53094() throws Exception {
        FavoritesService newService = new FavoritesService();
        List<ParkingLot> places = newService.getParkingLotInfo(53094, 20);
    ...
    @Test
    void getFavorites53590() throws Exception {
        FavoritesService newService = new FavoritesService();
        List<ParkingLot> places = newService.getParkingLotInfo(53590, 10);
